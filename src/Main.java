public class Main {
    ...
    public static void main(String[] args) {
        ...
        Hamburger hamburger=new Hamburger("White","Basic","Sausage",3.43);
        double price =hamburger.itemizeHamburger();
        hamburger.addHamburgerAddition1("Tomato",.32);
        hamburger.addHamburgerAddition2("Lettuch",.43);
        hamburger.addHamburgerAddition3("Cheese",.32);
       // price=hamburger.itemizeHamburger();
        System.out.println("Total price is "+hamburger.itemizeHamburger());
        HealthyBurger healthyBurger=new HealthyBurger("Bacon",5.67);
        healthyBurger.itemizeHamburger();
        healthyBurger.addHamburgerAddition1("Egg",4.32);
        healthyBurger.itemizeHamburger();
        healthyBurger.addHealthAddition1("Lentils",2.32);
        DeluxeBurger db=new DeluxeBurger();
        db.itemizeHamburger();
        db.addHamburgerAddition1("Should not do this ",43.43);
